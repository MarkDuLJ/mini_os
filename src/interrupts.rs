...
lazy_static!{
    static ref IDT: InterruptDescriptorTable = {
        ...
        // update double fault handler by using interrupt stack table
        unsafe {
...
extern "x86-interrupt" fn timer_interrupt_handler(_stack_frame: InterruptStackFrame){
    print!(".");// w/o end of interrupt, system doesnt know this interrupt is processed.

    // tell system is ready for next interrupt.
    unsafe {
